            ...
            <div class="container pad-bot-70 ">
                <div class="row mt-20">
                    <div class="col-md-12 col-xs-12 text-justify">
                        <div class="para-ad">
                            <p>Please fill up the form given below or contact us on the address / contact information given below. You would get a call back from us with 24 hours to address all your query!</p>
                        </div>
                    </div>
                </div>
               ...
               <div></div>
                <div class="row mt-20">
                    <!-- <div class="con-title">
                        <h2><span>Ask Admissions staff <b>all your questions</b></span></h2>
                    </div> -->
                        ...
                        <div class="form-container">
                            <form class="form-horizontal">
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Marks of Qualifying Exam</label>
                                    <input class="form-control" type="text" name="" placeholder="Enter Marks">
                                </div>
                                <div class="form-group">
                                <label>Type of Entrance Exam</label>
                                    <select name="" id="">
                                ...
                                <div class="form-group">
                                    <label>Marks of Entrance Exam</label>
                                    <input class="form-control" type="text" name="" placeholder="Enter Marks">
                                </div>
                                <div class="form-group">
                                <label>Select Course</label>
                                ...
                                <div class="form-group ">
                                    <label>City</label>
                                    <input class="form-control" type="text" name="" placeholder="Enter City">
                                </div>
                                <div class="form-group ">
                                    <label>State</label>
                                    <input class="form-control" type="text" name="" placeholder="Enter state">
                                </div>
                                <div class="form-group">
                                    <label>Email ID</label>
                                    <input class="form-control" type="email" name="" placeholder="Enter Mail">
                                </div>
                                <div class="form-group">
                                    <label>Mobile Number*</label>
                                    <input class="form-control" type="text" name="" placeholder="Enter Mob No.">
                                </div>
                                <!-- <div class="form-group">
                                    <label> Message</label>
                                    <textarea name="user-message" id="user-message" class="form-control" cols="10"
                    ...
                    <div class="col-md-4">
                      <div class="contact-details-box">
                        <div class="row ">
                          ...
                          <div class="col-xs-9">
                            <span class="condet">
                             <p>ALARD Knowledge Park, Survey No. 50, Hinjawadi Marunje, Near Rajiv Gandhi IT Park, Hinjewadi, Pune - 411057, Maharashtra, India.</p>
                            </span>
                          </div>
                        </div><hr>
                        <div class="row">
                          ...
                          <div class="col-xs-9">
                            <span class="condet">
                             <p>+91 982 243 7729 / +91 841101060</p>
                            </span>
                          </div>
                        </div><hr>

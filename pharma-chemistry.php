        ...
        <div class="head-2" id="rules">
            <div class="container">
                <div class="head-2-inn head-2-inn-padd-top">
                    <h1>College Of Pharmaceutics Chemistry</h1>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="ab-es">
            <div class="container pad-bot-70">
                ...
                <div class="row mt-40">
                    <p> <b>Pharmaceutical chemistry</b> is the study of drugs, and it involves drug development. This includes drug discovery, delivery, absorption, metabolism, and more. There are elements of biomedical analysis, pharmacology, pharmacokinetics, and pharmacodynamics. <b>Pharmaceutical chemistry</b>  work is usually done in a lab setting.</p>
                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="ad-detail-list">
                                                <ul>
                                                    ...
                                                    <li>Advanced Medicinal Chemistry – [Core Courses]</li>
                                                    <li>Advanced Organic Chemistry I [Core Courses]</li>
                                                    <li>Chemistry of Natural Products – [Core Courses]</li>                                                  
                                                    <li>Modern Pharmaceutical Analytical Techniques [Core Courses]</li>
                                                    <li>Pharmaceutical Chemistry Practical I [Core Courses]</li>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="ad-detail-list">
                                                <ul>
                                                    ...
                                                    <li>Computer Aided Drug Design [Core Courses]</li>
                                                    <li>Pharmaceutical Chemistry Practical II [Core Courses]</li>
                                                    <li>Pharmaceutical Process Chemistry [Core Courses]</li>
                                                    <li>Communication for Employment [Communication Skills]
                                                    </li>
